...
/**
 * @brief Calculates the pure number P_{n,p,q} for the YB scalar function in a two-body resistance problem.
 * 
 * @details
...
/**
 * @brief Calculates the pure number V_{n,p,q} for the YB scalar function in a two-body resistance problem.
 * 
 * @details
...
/**
 * @brief Calculates the pure number Q_{n,p,q} for the YB scalar function in a two-body resistance problem.
 * 
 * @details
...
/**
 * @brief Calculates the function f_{k}(\lambda) for the YB scalar function in a two-body resistance problem.
 * 
 * @details
...
/**
 * @brief Calculates the YB11 lubrication function for two spheres.
 * 
 * @details
 * This function computes the YB11 lubrication function which describes the hydrodynamic
 ...
 * 
 * @return The value of the YB11 lubrication function
 * 
...
/**
 * @brief Calculates the YB11 near-field function for two spheres.
 * 
 * @details
 * This function computes the YB11 lubrication function which describes the hydrodynamic
...
/**
 * @brief Calculates the YB11 far-field function for two spheres.
 * 
 * @details
 * This function computes the YB11 lubrication function which describes the hydrodynamic
 * interaction between two spheres. See Jeffrey and Onishi (1984).
...
/**
 * @brief Calculates the YB12 lubrication function for two spheres.
 * 
 * @details
 * This function computes the YB12 lubrication function which describes the hydrodynamic
 * interaction between two spheres. See Jeffrey and Onishi (1984) or Townsend (2023).
 * The normalization factor follows the one in Townsend (2023), or in Kim and Karrila (2005).
 * This is expected to be accurate for small separations only.
 * 
 ...
 * @param atol Absolute tolerance for convergence
 * 
 * @return The value of the YB12 lubrication function
 * 
 * @note The function uses cached g-coefficients for efficiency and combines them with
 *       logarithmic terms to compute the final result.
 */
...
/**
 * @brief Calculates the YB12 near-field function for two spheres.
 * 
 * @details
 * This function computes the YB12 lubrication function which describes the hydrodynamic
 * interaction between two spheres. See Jeffrey and Onishi (1984).
...
/**
 * @brief Calculates the YB12 far-field function for two spheres.
 * 
 * @details
 * This function computes the YB12 lubrication function which describes the hydrodynamic
 * interaction between two spheres. See Jeffrey and Onishi (1984).
...
/**
 * @brief Calculates the YB11 scalar resistance function
 * 
 * @details
 * This function computes the YB11 scalar resistance function which describes the hydrodynamic
 ...
 * @return double The YB11 function value
 */
double YB11(double s, double l, double lubr_cutoff, double cutoff, int maxIter, double rtol, double atol);

/**
 * @brief Calculates the YB12 scalar resistance function
 * 
 * @details
 * This function computes the YB12 scalar resistance function which describes the hydrodynamic
 * interaction between two spheres. The function uses a combination of lubrication, near-field,
 * and far-field approximations to compute the final result. The function automatically selects
 * the appropriate approximation based on the input parameters.
 *
 ...
 * @param[in] rtol Relative tolerance
 * @param[in] atol Absolute tolerance
 * @return double The YB12 function value
 */
double YB12(double s, double l, double lubr_cutoff, double cutoff, int maxIter, double rtol, double atol);
